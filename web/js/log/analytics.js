...
import {
  ...
  TRACE_ACTION_LABELS,
  EVENT_TYPES,
} from "../config.js?v=20260627-calm3";
import { average } from "../utils/format.js?v=20260627-calm3";
import {
  compactText,
  compactJson,
  safeObject,
  bracketParts,
} from "../utils/log-text.js?v=20260627-calm3";
import { getLogSearchText, detailKey, stableKeyText } from "../utils/dom.js?v=20260627-calm3";
import { buildLogEntries } from "./parser.js?v=20260627-calm3";
import { logFilesSignature, recentAnalysisEntries } from "./cache.js?v=20260627-calm3";
