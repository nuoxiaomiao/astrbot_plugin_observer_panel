...
import { INTERFACE_STATE_LABELS } from "../config.js?v=20260627-calm4";
import { formatBytes, formatPercent, formatNumber, shortUptime, usageKind } from "../utils/format.js?v=20260627-calm4";
import { $, setText, renderKv, detailRow, emptyBlock, renderWorkspaceChrome } from "../utils/dom.js?v=20260627-calm4";
