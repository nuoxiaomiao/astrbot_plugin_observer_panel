...
import { DIAGNOSTIC_LEVELS, IMPORTANT_EVENT_TYPES } from "../config.js?v=20260709-mobile1";
import { formatPercent, formatCompactLogTime, formatTime, shortUptime, usageKind } from "../utils/format.js?v=20260709-mobile1";
import {
  $,
  setText,
  setTextAnimated,
...
import { compactText, compactJson } from "../utils/log-text.js?v=20260709-mobile1";
import { renderBarChart } from "../components/chart.js?v=20260709-mobile1";
import { renderEventList } from "../components/event-list.js?v=20260709-mobile1";
import { checkDiagnosticNotifications } from "../ui.js?v=20260709-mobile1";
