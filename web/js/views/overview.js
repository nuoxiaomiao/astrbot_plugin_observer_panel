...
import { DIAGNOSTIC_LEVELS, IMPORTANT_EVENT_TYPES } from "../config.js?v=20260627-calm4";
import { formatPercent, formatCompactLogTime, formatTime, shortUptime, usageKind } from "../utils/format.js?v=20260627-calm4";
import {
  $,
  setText,
  renderSignature,
...
import { compactText, compactJson } from "../utils/log-text.js?v=20260627-calm4";
import { renderBarChart } from "../components/chart.js?v=20260627-calm4";
import { animateFillWidth } from "../utils/motion.js?v=20260627-calm4";
import { renderEventList } from "../components/event-list.js?v=20260627-calm4";
import { checkDiagnosticNotifications } from "../ui.js?v=20260627-calm4";
